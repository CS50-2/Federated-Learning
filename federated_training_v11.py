...
def main2():
    ...
    for r in range(rounds):
        ...
        print(f"\n 第 {r + 1} 轮聚合")
        is_comm_round = (r % 3 == 0)
        total_flops_this_round = 0  # FLOPs 累计
...
def main3():
    ...
    for r in range(rounds):
        ...
        round_comm = 0
        is_comm_round = (r % 3 == 0)
        total_flops_this_round = 0  # 本轮FLOPs
        ...
        if is_comm_round:
            ...
            # 非通信轮直接从缓存加载模型，FLOPs为0
            for cid in selected_clients:
                if cid in local_model_cache:
                    client_state_dicts.append((cid, local_model_cache[cid].state_dict()))
                else:
                    print(f" 缺失缓存，客户端 {cid} 被跳过")
        ...
        csv_data.append([
            ...
            elapsed_time, total_params_this_round, total_flops_this_round  # 新增一列
        ])
