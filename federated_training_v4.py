...
def split_data_by_label(dataset, num_clients=10):
    ...
    client_data_sizes = {
        0: {0: 600, 1: 700, 2: 600, 3: 600, 4: 500, 5: 500, 6: 500, 7: 600, 8: 500, 9: 500}, 
        1: {0: 700, 1: 600, 2: 600, 3: 600, 4: 500, 5: 400, 6: 600, 7: 500, 8: 500, 9: 600},
        2: {0: 500, 1: 600, 2: 700, 3: 600, 4: 600, 5: 500, 6: 500, 7: 600, 8: 600, 9: 500},
        3: {0: 600, 1: 600, 2: 500, 3: 500, 4: 600, 5: 600, 6: 600, 7: 500, 8: 500, 9: 700},
        4: {0: 600, 1: 500, 2: 600, 3: 600, 4: 500, 5: 500, 6: 600, 7: 700, 8: 500, 9: 500},
        5: {0: 500, 1: 700, 2: 500, 3: 500, 4: 600, 5: 600, 6: 500, 7: 600, 8: 700, 9: 600},
        6: {0: 600, 1: 600, 2: 600, 3: 600, 4: 700, 5: 500, 6: 600, 7: 500, 8: 500, 9: 600},
        7: {0: 700, 1: 500, 2: 600, 3: 600, 4: 500, 5: 600, 6: 500, 7: 600, 8: 500, 9: 600},
        8: {0: 500, 1: 600, 2: 500, 3: 500, 4: 600, 5: 500, 6: 600, 7: 500, 8: 700, 9: 700},
        9: {0: 600, 1: 700, 2: 600, 3: 600, 4: 600, 5: 500, 6: 600, 7: 500, 8: 600, 9: 500}
    }
...
def select_clients(client_loaders, use_all_clients=True, num_select=None, select_by_loss=False, global_model=None):
    ...
    if select_by_loss and global_model:
        #  计算每个客户端的 loss
        client_losses = {}
        for client_id, loader in client_loaders.items():  # 兼容新的客户端 ID 结构
            loss, _ = evaluate(global_model, loader)
            client_losses[client_id] = loss

        #  选择 loss 最高的 num_select 个客户端
...
def main():
    ...
    for r in range(rounds):
        print(f"\n🔄 第 {r+1} 轮聚合")
        # 选择客户端
        selected_clients = select_clients(client_loaders, use_all_clients=use_all_clients, num_select=num_selected_clients,
    ...
    plt.figure(figsize=(8, 5))
    plt.plot(total_communication_counts , global_accuracies, marker='s', linestyle='-', color='r', label="Test Accuracy vs. Communication")
